...
<div class="form-floating mb-3">
    <select class="form-select" id="entrada" name="entrada" style="background-color: #E6E6FA;" required>
        ...
        <option value="4:00 a 4:30" {{ old('entrada', $extra->entrada ?? '') == '4:00 a 4:30' ? 'selected' : '' }}>
            4:00 a 4:30
        </option>
    </select>
...
<div class="form-floating mb-3">
    <select class="form-select" id="encargado" name="encargado" style="background-color: #E6E6FA;" required>
        ...
        <option value="Ana Soto (Traspaleo F&V)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Ana Soto (Traspaleo F&V)' ? 'selected' : '' }}>Ana Soto (Traspaleo F&V)</option>
        <option value="Sebastian (Cámara refrigerados)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Sebastian (Cámara refrigerados)' ? 'selected' : '' }}>Sebastian (Cámara refrigerados)</option>
        <option value="Carlos Pérez (Salidas)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Carlos Pérez (Salidas)' ? 'selected' : '' }}>Carlos Pérez (Salidas)</option>
        <option value="Diana (Panadería)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Diana (Panadería)' ? 'selected' : '' }}>Diana (Panadería)</option>
        <option value="Blanca (Recibo)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Blanca (Recibo)' ? 'selected' : '' }}>Blanca (Recibo)</option>
        <option value="Guillermo (Mantenimiento)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Guillermo (Mantenimiento)' ? 'selected' : '' }}>Guillermo (Mantenimiento)</option>
        <option value="Esmeralda (Gte Almacén)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Esmeralda (Gte Almacén)' ? 'selected' : '' }}>Esmeralda (Gte Almacén)</option>
        <option value="Jessica (X)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Jessica (X)' ? 'selected' : '' }}>Jessica (X)</option>
        <option value="Jhonny (Tráfico)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Jhonny (Tráfico)' ? 'selected' : '' }}>Jhonny (Tráfico)</option>
        <option value="Brenda González (R.R.H.H)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Brenda González (R.R.H.H)' ? 'selected' : '' }}>Brenda González (R.R.H.H)</option>
        <option value="Claudia González (S.P)" {{ old('encargado', $entrgadespensa->encargado ?? '') == 'Claudia González (S.P)' ? 'selected' : '' }}>Claudia González (S.P)</option>
    </select>
