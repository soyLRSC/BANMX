...
<div class="form-floating mb-3">
    ...
    value="{{old('fecha',$entrgadespensa->fecha ?? '')}}" 
...
<div class="form-floating mb-3">
    ...
    value="{{old('cantidad',$entrgadespensa->cantidad ?? '')}}" 
    style="background-color: #E6E6FA;" required>
...
<div class="form-floating mb-3">
    <select class="form-select" id="responsable" name="responsable" style="background-color: #E6E6FA;" required>
        ...
        <option value="Claudia Gonzalez" {{ old('responsable', $entrgadespensa->responsable ?? '') == 'Claudia Gonzalez' ? 'selected' : '' }}>Claudia González</option>
         <option value="Brenda Gonzalez" {{ old('responsable', $entrgadespensa->responsable ?? '') == 'Brenda Gonzalez' ? 'selected' : '' }}>Brenda González</option>
          <option value="Jazmin Rios" {{ old('responsable', $entrgadespensa->responsable ?? '') == 'Jazmin Rios' ? 'selected' : '' }}>Jazmin Rios</option>
           <option value="Montserrat" {{ old('responsable', $entrgadespensa->responsable ?? '') == 'Montserrat' ? 'selected' : '' }}>Montserrat</option>
             <option value="Guardia" {{ old('responsable', $entrgadespensa->responsable ?? '') == 'Guardia' ? 'selected' : '' }}>Guardia</option>
             <option value="Apoyo" {{ old('responsable', $entrgadespensa->responsable ?? '') == 'Apoyo' ? 'selected' : '' }}>Apoyo</option>
            </select>
