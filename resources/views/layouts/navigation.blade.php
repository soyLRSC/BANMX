...
<nav class="navbar navbar-expand-lg   border-bottom">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarMain">
      ...
      @auth
    @if (Auth::user()->rol === 'guardia')
      
        <li class="nav-item"><a class="nav-link" href="{{url('/ingreso_salidas/create')  }}">ingreso </a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('/anticipadas')  }}">anticipadas </a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('/bajas')  }}">bajas </a></li>
       
      
        <li class="nav-item"><a class="nav-link" href="{{url('/permitidas')  }}">permitidas </a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('/reingresos')  }}">reingresos </a></li>
        <li class="nav-item"><a class="nav-link" href="{{ url('/entradaguardia/create') }}">Ingresos salidas guardia</a></li>
       @endauth
       @endif
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarRegistros">
        <li><a class="dropdown-item" href="{{ route('registros.index') }}">Ver registros</a></li>
        <li><a class="dropdown-item" href="{{ route('registros.create') }}">Agregar registro</a></li>
  
        <li><a class="dropdown-item" href="{{ route('registros.exportar') }}">Exportar registros</a></li>
    </ul>
</li>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarAnticipadas">
        ...
        <li><a class="dropdown-item" href="{{ route('anticipadas.create') }}">Agregar salidas anticipada</a></li>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarMovimientos">
        <li><a class="dropdown-item" href="{{ route('movimientos.index') }}">Ver movimientos</a></li>
        <li><a class="dropdown-item" href="{{ route('movimientos.create') }}">Agregar movimiento</a></li>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarNorecibio">
        <li><a class="dropdown-item" href="{{ route('norecibio.index') }}">Ver personas que no recibieron despensa</a></li>
        <li><a class="dropdown-item" href="{{ route('norecibio.create') }}">Registrar</a></li>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarPermitidas">
        ...
        <li><a class="dropdown-item" href="{{ route('permitidas.create') }}">Registrar salidas permitidas</a></li>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarReingresos">
        <li><a class="dropdown-item" href="{{ route('reingresos.index') }}">Ver reingresos</a></li>
        <li><a class="dropdown-item" href="{{ route('reingresos.create') }}">Registrar reingreso</a></li>
...
<li class="nav-item"> <a class="nav-link" href="{{ route('users.index') }}">Administrar Usuarios</a></li>
@endif
@endauth
