...
<div class="form-floating mb-3">
    <select class="form-select" id="concepto" name="concepto" style="background-color: #E6E6FA;" required>
        ...
        <option value="fumar" <?php echo e(old('concepto', $reingreso->motivo ?? '') == 'Fumar' ? 'selected' : ''); ?>>Sale a fumar</option>
        <option value="Sanitario" <?php echo e(old('concepto', $reingreso->motivo ?? '') == 'Sanitario' ? 'selected' : ''); ?>>Sanitario</option>
          <option value="Despensa" <?php echo e(old('concepto', $reingreso->motivo ?? '') == 'recoger despensa' ? 'selected' : ''); ?>>Recoger Despensa</option>
...
<script>
  ...
  <script src="https://unpkg.com/html5-qrcode" type="text/javascript"></script><?php /**PATH D:\larabel\laragon\www\BANMGDL\resources\views/reingresos/form-fields.blade.php ENDPATH**/ ?>