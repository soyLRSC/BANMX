...
<body>
  ...
  <header>
    <div class="logo-titulo">
      <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo BAMX" class="logo">
      ...
      <a href="#">Inicio</a>
            ...
            <?php if(Route::has('login')): ?>
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Ingresa</a>

                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Registrate</a>
                        <?php endif; ?>
                    <?php endif; ?>
  ...
  <footer>
    <p>© 2025 <strong>BAMX</strong> | Nexunity Labs</p>
         ...
         <?php /**PATH D:\larabel\laragon\www\BANMGDL\resources\views/welcome.blade.php ENDPATH**/ ?>