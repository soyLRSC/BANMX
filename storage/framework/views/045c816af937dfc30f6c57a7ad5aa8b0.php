    ...
    <select class="form-select" id="id_registro" name="id_registro" style="background-color: #E6E6FA;" >
        ...
        <?php $__currentLoopData = $registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($registro->id); ?>" 
                <?php echo e(old('id_registro', $norecibio->id_registro ?? '') == $registro->id ? 'selected' : ''); ?>>
                <?php echo e($registro->nombre ?? 'Registro #' . $registro->id); ?>
...
<div class="form-floating mb-3">
    <input type="date" class="form-control" id="fecha" name="fecha" placeholder="Fecha"
        value="<?php echo e(old('fecha', $norecibio->fecha ?? date('Y-m-d'))); ?>"
...
<div class="form-floating mb-3">
    <input type="text" class="form-control" id="concepto" name="concepto" placeholder="Motivo"
        value="<?php echo e(old('concepto', $norecibio->concepto ?? '')); ?>"
        style="background-color: #E6E6FA;" required>
...
<script>
  ...
  <script src="https://unpkg.com/html5-qrcode" type="text/javascript"></script><?php /**PATH D:\larabel\laragon\www\BANMGDL\resources\views/norecibio/form-fields.blade.php ENDPATH**/ ?>